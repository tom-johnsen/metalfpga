...
constant constexpr uint GPGA_SCHED_FLAG_VM_DEBUG = 4u;
constant constexpr uint GPGA_SCHED_FLAG_EXEC_READY = 8u;
constant constexpr uint GPGA_SCHED_VM_DEBUG_WORDS = 16u;
...
constant constexpr uint GPGA_SCHED_VM_ASSIGN_FLAG_IS_ARRAY = 1u << 2u;
constant constexpr uint GPGA_SCHED_VM_ASSIGN_FLAG_IS_BIT_SELECT = 1u << 3u;
